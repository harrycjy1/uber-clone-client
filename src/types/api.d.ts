...
export interface sendMessage_SendChatMessages_message {
  __typename: "Message";
  id: number;
  text: string;
  userId: number | null;
...
export interface sendMessage_SendChatMessages {
  __typename: "SendChatMessagesResponse";
  ok: boolean;
  error: string | null;
  message: sendMessage_SendChatMessages_message | null;
}

export interface sendMessage {
  SendChatMessages: sendMessage_SendChatMessages;
}
...
export interface requestRide {
  RequestRide: requestRide_RequestRide | null;
}
...
export interface acceptRide {
  UpdateRideStatus: acceptRide_UpdateRideStatus | null;
}
...
export interface updateRide {
  UpdateRideStatus: updateRide_UpdateRideStatus | null;
}
